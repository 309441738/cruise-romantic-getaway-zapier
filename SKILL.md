---
name: cruise-romantic-getaway
title: cruise-romantic-getaway
description: 为情侣提供浪漫邮轮之旅的精选产品，打造难忘的回忆。
kind: MCP
version: 0.1.0
published_with: cruiseskillbridge
---

# cruise-romantic-getaway

> 为情侣提供浪漫邮轮之旅的精选产品，打造难忘的回忆。
...
```json
{ "input": "...", "skill": "cruise-romantic-getaway" }
```
